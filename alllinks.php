...
?>  
<a href="indexlinks.php" class="btn btn-primary">
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($resultpartners)): ?>
                <tr>
                    ...
                    <td><a href="indexlinks.php?partnerid=<?= htmlspecialchars($row['id'], ENT_QUOTES) ?>" class="btn btn-warning">Просмотреть ссылки</a></td>
                </tr>
            <?php endwhile; ?>
        </tbody>
    </table>
